...
namespace Assignment6Cottrell.Models
{
    public class Movie : Media
    {
        ...
        //{
        //    Console.WriteLine($"THE MOVIE {Title} in {Theater}");
        //}


        public override void Display()
        {
            //tried using the CSVHelper...
            ...
            else
            {
                ...
                do
                {
                    ...
                    if (choice == "1")
                    {
                        //reader.AddMovie(MovieIds, MovieTitles, MovieGenres, file);
                        Console.WriteLine($"hello");
                    }
                    else if (choice == "2")
                    {
                        // reader.viewMovie(MovieIds, MovieTitles, MovieGenres, file);
